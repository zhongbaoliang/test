...
public class ByteStream {
    public static void noBuffered() throws IOException {
        ...
        try {
            fileInputStream=new FileInputStream("src/javaee/io/basic/ByteStream.java");
    ...
    public static void buffered(){
        ...
        try(FileInputStream fileInputStream=new FileInputStream("src/javaee/io/basic/ByteStream.java");
            FileOutputStream fileOutputStream=new FileOutputStream("src/javaee/io/out.txt");) {
            int len=0;
